...
- Use a private GitHub repository as the remote backup/review system when the correct remote URL is available.
...
- GitHub setup is explicit instead of guessed.
